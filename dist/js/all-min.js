...
(function e(t, n, r) {
   ...
   */
    ...
    */
		...
		var $ = require('jquery');
		var alumnos = [{ "codigo": 1, "nombre": "sergio", "apellidos": "aparicio vegas", "dni": "44974398z", "email": "xxxxx@xxx.xx", "telefono": "+3494" }, { "codigo": 2, "nombre": "maite", "apellidos": "monasterio herrero", "dni": "16071559x", "email": "xxxxx@xxx.xx", "telefono": "+3494" }, { "codigo": 3, "nombre": "jorge", "apellidos": "manso rodriguez", "dni": "16412750e", "email": "xxxxx@xxx.xx", "telefono": "+3494" }];
		...
		$(document).ready(function ($) {
			...
			var urlAlumnos = "http://localhost:8080/gestiondocente/api/alumnos.json";
			ajax({ "url": urlAlumnos, "method": "get" }).then(function (data) {
			...
			function cargarAlumnos() {
				$.ajax({ "url": urlAlumnos, "method": "get" }).done(function (data) {
					//
